  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button className="bg-accent hover:bg-indigo-400 text-white px-4 py-2 rounded-lg text-sm font-medium flex items-center gap-2 transition-colors shadow-lg shadow-accent/20">
          <Plus size={16} />
          New Setup
        </button>
      </div>
